...
### topleft
with(hpcDate, plot(Global_active_power, 
                   type = "l", xlab = "",
...
#### topright
with(hpcDate, plot(Voltage,
                   type= "l", xlab = "datetime",
                   xaxt = "n",
                   yaxt = "n"))
axis(side = 1, labels = c("Thu", "Fri", "Sat"), at = c(0, 1440, 2880))
axis(side = 2, labels = c("234", "238", "242", "246"), at = c(234000, 238000, 242000, 246000))
...
#### bottomright
with(hpcDate, plot(Global_reactive_power,
                   type= "l", xlab = "datetime",
                   xaxt = "n"))
axis(side = 1, labels = c("Thu", "Fri", "Sat"), at = c(0, 1440, 2880))
